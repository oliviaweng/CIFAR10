...
def resnet_v1_eembc(
    ...
    l1p=0,
    l2p=1e-4,
    num_filters=[16, 16, 32, 32, 64, 64],  # block 1  # block 2  # block 3
    kernel_sizes=[3, 3, 3, 3, 3, 1, 3, 3, 1],  # block 1  # block 2  # block 3
    strides=[
        "111",  # block 1
        "212",  # block 2
        "212",  # block 3
...
def resnet_v1_eembc_quantized_fkeras(
    input_shape=[32, 32, 3],
    num_classes=10,
    l1p=0,
    l2p=1e-4,
    ...
    if (
        ...
        y = BatchNormalization()(y)
        x = QActivation(activation=logit_quantizer)(y)
